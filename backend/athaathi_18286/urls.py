"""athaathi_18286 URL Configuration
...
admin.site.site_header = "Athaathi"
admin.site.site_title = "Athaathi Admin Portal"
admin.site.index_title = "Athaathi Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Athaathi API",
        default_version="v1",
        description="API documentation for Athaathi App",
    ),
    public=True,
